...
namespace ONNXML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\cohor\Desktop\codemotion\sentiments.csv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey("Sentiment", "Sentiment")
                                      .Append(mlContext.Transforms.Text.FeaturizeText("ReviewText_tf", "ReviewText"))
                                      .Append(mlContext.Transforms.CopyColumns("Features", "ReviewText_tf"))
